...
DPT_code int primary key,DPT_Name varchar(34),DPT_ALLOTMENT int)

insert into  emp_department values( 57,'IT',65000),(63,'Finance',15000),
(47,'HR',240000),(27,'RD',55000),(89,'QC',75000)
...
NAME varchar(43),
city char(37),commission decimal(2,2)
);
...
--Solution No:-7
select AVG(pro_price) as "Average Price", company.com_name as "Company Name" from item_mast join company on item_mast.pro_com=company.com_id
